...
class ThreadPanel extends Panel {

    Button start_;
    Button stop_;
    DisplayThread A_;

    ThreadPanel(String title, Color c, Runnable r) {
         super();
        // Set up Buttons
    ...
    public synchronized void update(Graphics g){
	    ...
	    offgraphics.fillRect(0, 0, d.width, d.height);
         ...
         if (angle_<segStart_) {
            ...
            offgraphics.fillArc(50,50,90,90,0,angle_);
         } else if ( angle_>=segStart_ && angle_<segEnd_) {
            offgraphics.setColor(arcColor_);
            offgraphics.fillArc(50,50,90,90,0,segStart_);
            offgraphics.setColor(segColor_);
            offgraphics.fillArc(50,50,90,90,segStart_,angle_-segStart_);
         } else  {
            offgraphics.setColor(arcColor_);
            offgraphics.fillArc(50,50,90,90,0,segStart_);
            offgraphics.setColor(segColor_);
            offgraphics.fillArc(50,50,90,90,segStart_,segEnd_-segStart_);
            offgraphics.setColor(arcColor_);
            offgraphics.fillArc(50,50,90,90,segEnd_,angle_-segEnd_);
         }
